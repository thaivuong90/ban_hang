    ...
    <table class="list" id="myTable">
        ...
        <tbody id="tbody">
            ...
            <tr>
                ...
                <td class="editName" style="width:100px;">
                    
                    <?php echo $rows["name"]; ?>
                </td>
                <td class="editName" style="width:221px;">
                    
                    <?php echo $rows["url"]; ?>
                </td>
                <td style="text-align: center;width:137px;"><?php echo $rows['create_at']; ?></td>
                <td style="text-align: center;width:100px;"><?php echo $rows['create_by']; ?></td>
                <td style="text-align: center;width:50px;"  class="editImg">
                    <?php echo $rows['order_by']; ?>
                </td>
                <td style="text-align: center;width:50px;" class="editStatus">
                ...
                <td class="canEdit" style="width:18px;">
                    <a class="edit_icon" title="Sửa" href="<?php echo base_url('admin/menus/edit/'.$rows['id']); ?>"></a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php else: ?>
