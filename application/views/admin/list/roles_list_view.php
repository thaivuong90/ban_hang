    ...
    <table class="list">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a class="edit_icon" title="Sửa" href="<?php echo base_url("admin/roles/edit/".$rows["id"]); ?>"></a></td>
                <td>
                <a class="delete_icon" title="Xóa" href="<?php echo base_url("admin/roles/delete/".$rows["id"]); ?>" onclick="return doConfirm('<?php echo LTV0008 ?>');" ></a>
                </td>
            </tr>
            <?php endforeach; ?>
            <?php else: ?>
